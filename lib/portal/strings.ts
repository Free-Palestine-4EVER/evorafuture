...
export const P = {
  ...
  confirm_del: { en: "Delete?", ar: "حذف؟" },
  confirm_del_project: { en: "Delete this project and its whole timeline? This cannot be undone.", ar: "حذف هذا المشروع وكامل مساره؟ لا يمكن التراجع عن ذلك." },
  confirm_del_update: { en: "Delete this update?", ar: "حذف هذا التحديث؟" },
  yes_delete: { en: "Yes, delete", ar: "نعم، احذف" },
  save: { en: "Save", ar: "حفظ" },
  saving: { en: "Saving…", ar: "جارٍ الحفظ…" },
  cancel: { en: "Cancel", ar: "إلغاء" },
  save_failed: { en: "Couldn't save. Check your connection and try again.", ar: "تعذّر الحفظ. تحقّق من اتصالك وحاول مجددًا." },
  delete_failed: { en: "Couldn't delete. Try again.", ar: "تعذّر الحذف. حاول مجددًا." },
  load_failed: { en: "Couldn't load your designs. Check your connection.", ar: "تعذّر تحميل تصاميمك. تحقّق من اتصالك." },
