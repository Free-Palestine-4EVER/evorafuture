...
export const tourHotspots: Hotspot[] = [
  { id: "bed", x: 0.5, y: 0.70, name: { en: "Aspen Oak Bed", ar: "سرير أسبن البلوط" } },
  { id: "lamp", x: 0.26, y: 0.58, name: { en: "Amber Table Lamp", ar: "مصباح آمبر" } },
  { id: "nightstand", x: 0.735, y: 0.78, name: { en: "Linen Nightstand", ar: "كومودينو لينين" } },
